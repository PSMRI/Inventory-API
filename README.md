...
For detailed steps, refer to the [Developer Guide](https://piramal-swasthya.gitbook.io/amrit/developer-guide/development-environment-setup)
### Prerequisites
* JDK 17
* Wildfly 11
* MySQL
...
- Example: `feat(inventory): add product search functionality`
